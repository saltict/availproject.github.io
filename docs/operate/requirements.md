...
| ------------- | --------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| **Full Node** | [<ins>avail</ins>](https://github.com/availproject/avail) | [<ins>v1.9.0.0</ins>](https://github.com/availproject/avail/releases/tag/v1.9.0.0) |
...
| --------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Full Node | [<ins>availj/avail</ins>](https://hub.docker.com/r/availj/avail/tags) | [<ins>v1.9.0.0</ins>](https://hub.docker.com/layers/availj/avail/v1.9.0.0/images/sha256-f721dd15c77389a3c94002e22a6abb06bf75dd93812328f09c4871621dc138ad?context=explore) |
