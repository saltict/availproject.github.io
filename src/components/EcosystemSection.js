                            ...
                            >
                              ...
                              <ul className="network-info-list">
                                ...
                                <li>
                                  ...
                                  {detail.chainSpec ? (
                                    <a
                                      href={detail.chainSpec.link}
                                      className="network-link"
                                    >
                                      {detail.chainSpec.text}
                                    </a>
                                  ) : (
                                    'N/A'
                                  )}
                                ...
                                <li>
                                  ...
                                  {detail.chainInfo ? (
                                    <a
                                      href={detail.chainInfo.link}
                                      className="network-link"
                                    >
                                      {detail.chainInfo.text}
                                    </a>
                                  ) : (
                                    'N/A'
                                  )}
                                ...
                                <li>
                                  ...
                                  {detail.nodeVersion ? (
                                    <a
                                      href={detail.nodeVersion.link}
                                      className="network-link"
                                    >
                                      {detail.nodeVersion.text}
                                    </a>
                                  ) : (
                                    'N/A'
                                  )}
                                ...
                                <li>
                                  ...
                                  {detail.lightClientVersion ? (
                                    <a
                                      href={detail.lightClientVersion.link}
                                      className="network-link"
                                    >
                                      {detail.lightClientVersion.text}
                                    </a>
                                  ) : (
                                    'N/A'
                                  )}
